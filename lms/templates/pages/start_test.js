   ...
   var result = "<table class='table table-bordered table-striped'><tbody>";
	...
	console.log(TestResult);
     frappe.call({
            ...
            args: {
               doc:{"doctype":"Exam Result","created_date":"2018-02-23 18:59:51",
                    "user":$("#UserInfoId").val(),
                    "user_correct_ansmers":TestResult.UserCorrectAnsmers,
                    "wrong_ansmers":TestResult.WrongAnsmers,
                    "attend_ansmers":TestResult.AttendAnsmers,
                    "total_marks":TestResult.TotalMarks,
                    "secured_marks":TestResult.SecuredMarks,
